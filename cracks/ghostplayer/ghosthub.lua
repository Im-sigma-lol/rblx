...
data["key_link"] = "https://start-get-key.pages.dev/"
...
local function ShowKeyGui()
 ...
 G2L["TextLabel_c"]["Text"] = "Wants a key free? https://www.roblox.com/game-pass/1529641694/Access-Card";
 ...
 local request = request or (syn and syn.request) or http_request or (http and http.request)
 if request({ Url = data["domain"].."check/"..G2L["TextBox_5"]["Text"], Method = "GET" }).Body == "200: Success" and request({ Url = data["domain"].."check/"..G2L["TextBox_5"]["Text"], Method = "GET" }).StatusCode == 200 then
    if writefile then
 ...
 G2L["TextBox_5"]["Text"] = data["key_link"]
